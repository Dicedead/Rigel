 ...
 */
public final class Tree<T> extends GraphComms<Node<T>, DirectedLink<Node<T>>> {
     ...
     */
    @Override
    public GraphComms<Node<T>, DirectedLink<Node<T>>> on(Set<Node<T>> points) {
     ...
     */
    @Override
    public GraphComms<Node<T>, DirectedLink<Node<T>>> component(Node<T> point) {
        return this;
    }
     ...
     */
    @Override
    public GraphComms<Node<T>, DirectedLink<Node<T>>> intersection(GraphComms<Node<T>, DirectedLink<Node<T>>> otherGraph) {
